...
<img width="966" height="1482" alt="51b90697a290d49bbc426ce7286011e7" src="https://github.com/user-attachments/assets/4b20d5d9-d5b3-479a-a7aa-cfbd5bf4a268" />
...
- 演示账号：admin
- 演示密码：123456
- 演示数据：每天 12:00（Asia/Shanghai）自动回滚，期间提交的数据不保证保留。
